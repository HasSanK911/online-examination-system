...
<div class="header">
    ...
    <div class="subtitle">Exam Result Report &mdash; Generated {{ now()->format('d M Y') }}</div>
</div>

<h2>{{ $exam['title'] }}</h2>
<table style="margin-bottom:12px">
    <tr><td style="width:120px"><span class="info-label">Course</span></td><td>{{ $exam['course'] }}</td></tr>
    <tr><td><span class="info-label">Total Marks</span></td><td>{{ $exam['total_marks'] }}</td></tr>
    <tr><td><span class="info-label">Date</span></td><td>{{ \Carbon\Carbon::parse($exam['date'])->format('d M Y') }}</td></tr>
</table>

<div class="summary">
    <div class="summary-cell"><div class="summary-num">{{ $summary['total'] }}</div><div class="info-label">Total Students</div></div>

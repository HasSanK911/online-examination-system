...
<div class="header">
    ...
    <div class="subtitle">Department Performance Report &mdash; Generated {{ now()->format('d M Y') }}</div>
</div>

<h2>{{ $department }} <span style="font-weight:normal;color:#64748b;">({{ $faculty }})</span></h2>

<div class="summary">
    <div class="summary-cell"><div class="summary-num">{{ $summary['total_students'] }}</div><div class="info-label">Students</div></div>
    <div class="summary-cell"><div class="summary-num">{{ $summary['total_exams'] }}</div><div class="info-label">Exams Taken</div></div>
    ...
    <div class="summary-cell"><div class="summary-num">{{ $summary['avg_percentage'] }}%</div><div class="info-label">Average Score</div></div>
</div>
